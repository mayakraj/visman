...
def dashboard_members():
    ...
    try:
        ...
        return result  #resukt is working i need to add two params as status and messgae 
...
def create_or_update(data):
    try:
        ...
        try:
            ...
            return {"status":"true","message":"Status Updated"}     #update this to mobile dev when you change this as usal this is for the testing pupose only
